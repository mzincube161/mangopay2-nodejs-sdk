...
Api.prototype = {
    ...
    method: function(method, callback, options) {
        ...
        if (options && options.headers) {
            requestOptions.headers = _.extend(requestOptions.headers, this.requestOptions.headers, options.headers);
            console.log("custom headers have been set")
        }
    ...
    authorize: function(callback) {
        ...
        console.log(self.requestOptions.headers)
